...
const CATEGORIAS = {
  ingreso: ['Matrícula', 'Cuota mensual', 'Transferencia alumno', 'Nequi', 'Daviplata', 'Efectivo', 'Venta de molde', 'Venta de producto', 'Venta de pizarra digitalizadora', 'Envío cobrado al cliente', 'Otro ingreso'],
